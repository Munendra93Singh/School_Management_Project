...
namespace School_Management_Project
{
    public partial class AdmissionForm : System.Web.UI.Page
    {
        ...
        //{
        //    String mycon = "Data Source=.; Initial Catalog=DB_SchoolManagement; Integrated Security= True;";
        //    SqlConnection scon = new SqlConnection(mycon);
        //    String myquery = "select Student_Id from TBL_AdmissionStudent";
        ...
        //    else
        //    {
        //        String mycon1 = "Data Source=.; Initial Catalog=DB_SchoolManagement; Integrated Security= True;";
        //        SqlConnection scon1 = new SqlConnection(mycon1);
        //        String myquery1 = "select Student_Id from TBL_AdmissionStudent";
        ...
        //        {
        //            var Student_Id = dr["Student_Id"].ToString();
        ...
        //public void savedata()
            ...
            if (btnsave.Text == "Save")
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("sp_TBL_AdmissionStudent", con);
                cmd.CommandType = CommandType.StoredProcedure;
