<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RagistrationAdmin.aspx.cs" Inherits="School_Management_Project.Ragistration" %>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <table style="padding-left: 13px">
                            ...
                            <tr>
                                ...
                                <td><asp:Button ID="btnsave" runat="server" Style="background-color: #e74c3c" Text="Ragistration" class="entypo-lock"  /></td>
                            </tr>
